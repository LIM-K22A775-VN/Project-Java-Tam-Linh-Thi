    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        // Nếu là request tới file tĩnh, trả quyền xử lý lại cho Tomcat
        if (uri.endsWith(".png") || uri.endsWith(".jpg") || uri.endsWith(".css") || uri.endsWith(".js")) {
            request.getRequestDispatcher(uri).forward(request, response);
            return;
        }
    
        // Còn lại thì forward đến intro_qc.jsp
        request.getRequestDispatcher("/templates/intro_qc.jsp").forward(request, response);
    }
