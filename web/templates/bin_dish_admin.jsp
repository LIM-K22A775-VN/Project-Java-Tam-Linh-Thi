        ...
        <div class="main" id="main">
            ...
            <div class="content">
                <div class="trash-header">
                    <a href="dish_admin.jsp" class="btn btn-back">⬅ Quay lại danh sách</a>
                </div>
                ...
                <div class="table">
                    <table class="trash-table">
                        ...
                        <tbody>
                            <c:forEach var="sp" items="${listDeletedProducts}" varStatus="st">
                                <tr>
                                    <td>${st.index + 1}</td>
                                    <td><img src="${pageContext.request.contextPath}/static/avatars/media/${sp.hinh}" width="50"></td>
                                    <td>${sp.tenSanPham}</td>
                                    <td>${sp.danhMuc}</td>
                                    <td>${sp.gia} VND</td>
                                    <td>
                                        <form action="KhoiPhucSanPhamServlet" method="post" style="display:inline;">
                                            <input type="hidden" name="id" value="${sp.id}">
                                            <button type="submit" class="btn btn-success"><i class="fas fa-undo"></i> Khôi phục</button>
                                        </form>
                                        <form action="XoaVinhVienSanPhamServlet" method="post" style="display:inline;">
                                            <input type="hidden" name="id" value="${sp.id}">
