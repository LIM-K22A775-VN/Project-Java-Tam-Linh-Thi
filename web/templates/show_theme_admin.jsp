            ...
            <div class="filter-section">
                ...
                <div class="action-buttons">
                    <button class="btn btn-green">
                        <a href="add_theme_admin.jsp" style="text-decoration: none;color: #fff;">
                            <i class="fa fa-plus"></i> Thêm
                        </a>
                    </button>
                    <button class="btn btn-red">
                        <a href="bin_show_theme.jsp" style="text-decoration: none;color: #fff;">
            ...
            <table class="post-table">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>Cách làm gà ủ muối hoa tiêu thơm ngon đúng vị</td>
                        <td>Gà ủ muối có nhiều cách làm khác nhau, tùy vào tay mỗi đầu bếp...</td>
                        <td>Công thức nấu ăn</td>
                        <td>post</td>
                        <td style="min-width: 110px;"><span class="label-new">Bài viết mới</span></td>
                        <td style="min-width: 210px;">
                            <button class="btn btn-green" title="Trạng thái"><i class="fa fa-circle"></i></button>
                            <button class="btn btn-eye" title="Xem">
                                <a href="detail_showtheme_admin.jsp" style="text-decoration: none;color: #fff;">
                                    <i class="fa fa-eye"></i>
                                </a>
                            </button>
                            <button class="btn btn-blue" title="Sửa">
                                <a href="edit_showtheme_admin.jsp" style="text-decoration: none;color: #fff;">
                                    <i class="fa fa-pen"></i>
                                </a>
                            </button>
