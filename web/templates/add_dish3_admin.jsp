            ...
            <div class="content">
                <div class="container">
                    <div class="form-header">
                        <button class="btn-save"><i class="fa-solid fa-square-plus" style="vertical-align: middle; margin-right: 6px;"></i> Thêm</button>
                        ...
                        <div class="form-grid">
                            <div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" id="datetime" name="created_at">
                                </div>
                                <div class="form-group">
                            ...
                            <div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" id="sale" name="sale_price" value="46000">
                                </div>
                                <div class="form-group">
