...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/CssTotal/dish2_admin.css"/>
</head>
<body>
            ...
            <div class="main-container">
                <div class="bin-section">
                    <button class="btn-trash">
                        <a href="bin2_dish2_admin.jsp" style="text-decoration: none;color: #fff;">
                            Thùng rác
                        </a>
                    </button>
                </div>
                ...
                <div class="container">
                    <div class="form-section">
                        <form action="${pageContext.request.contextPath}/addCategory" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="area" id="mo-ta" name="moTa" rows="4" cols="10"></textarea>
                            </div>
                            <div class="form-group">
                    ...
                    <div class="table-section">
                            ...
                            <tbody>
                                <c:forEach var="item" items="${listCategories}">
                                    <tr>
                                        ...
                                        <td>
                                            <img src="${pageContext.request.contextPath}/static/avatars/media/${item.image}" alt="${item.ten}">
                                        </td>
                                        <td>${item.ten}</td>
                                        <td>${item.slug}</td>
                                        <td>${item.soLuong}</td>
                                        ...
                                        <td class="actions">
                                            ...
                                            <button class="btn-view" title="Xem">
                                                <a href="${pageContext.request.contextPath}/showCategory?id=${item.id}" style="text-decoration: none;color:#fff;">
                                                    <i class="fa fa-eye"></i>
                                                </a>
                                            </button>
                                            <button class="btn-edit" title="Sửa">
                                                <a href="${pageContext.request.contextPath}/editCategory?id=${item.id}" style="text-decoration: none;color:#fff;">
                                                    <i class="fa fa-pen"></i>
                                                </a>
                                            </button>
                        ...
                        <div style="margin-top: 15px; display: flex; justify-content: space-between; align-items: center;">
                            <span>Hiển thị ${listCategories.size()} kết quả</span>
