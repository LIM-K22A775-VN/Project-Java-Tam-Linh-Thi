    ...
    <div class="main" id="main">
        ...
        <div class="content">
            <div class="trash-header">
                <a href="storage2_admin.jsp" class="btn btn-back">⬅ Quay lại danh sách</a>
            </div>
            <div class="table">
                <table class="trash-table">
                    ...
                    <tbody>
                        <!-- Nếu lấy dữ liệu từ Servlet -->
                        <c:forEach var="item" items="${trashList}">
                            <tr>
                                <td>${item.id}</td>
                                ...
                                <td>${item.giaNhap}</td>
                                <td>
                                    <form action="KhoiPhucNguyenLieuServlet" method="post" style="display:inline;">
                                        <input type="hidden" name="id" value="${item.id}">
                                        <button class="btn btn-success"><i class="fas fa-undo"></i> Khôi phục</button>
                                    </form>
                                    <form action="XoaNguyenLieuServlet" method="post" style="display:inline;">
                                        <input type="hidden" name="id" value="${item.id}">
