...
<html lang="vi">
    <head>
        ...
        <!-- Dùng contextPath để đường dẫn hoạt động đúng trong mọi môi trường -->
        ...
        <div class="main" id="main">
            ...
            <div class="content">
                <div class="trash-header">
                    <a href="storage1_admin.jsp" class="btn btn-back">⬅ Quay lại danh sách</a>
                </div>
                ...
                <div class="table">
                    <table class="trash-table">
                        ...
                        <tbody>
                            <!-- Có thể sau này dùng JSTL để lặp danh sách -->
                            <tr>
                                <td>1</td>
                                <td>Viên thả lẩu</td>
                                <td>5</td>
