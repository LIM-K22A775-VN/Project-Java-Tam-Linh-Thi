...
<head>
    ...
    <link rel="stylesheet" href="<%=request.getContextPath()%>/static/CssTotal/storage4.css"/>
</head>
<body>
            ...
            <div class="main-container">
                <div class="bin-section">
                    <button class="btn-trash">
                        <a href="bin_storage4_admin.jsp" style="text-decoration: none;color: #fff;">Thùng rác</a>
                    </button>
                </div>
                <div class="container">
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="ghichu" name="name" rows="5"></textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <table>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>200000</td>
                                    <td class="actions">
                                        <button class="btn-status" title="Cảnh báo"><i class="fa-solid fa-triangle-exclamation"></i></button>
                                        <button class="btn-view" title="Xem">
                                            <a href="detail_storage4_admin.jsp" style="text-decoration: none;color: #fff;">
                                                <i class="fa fa-eye"></i>
                                            </a>
                                        </button>
                                        <button class="btn-edit" title="Sửa">
                                            <a href="edit_storage4_admin.jsp" style="text-decoration: none;color: #fff;">
                                                <i class="fa fa-pen"></i>
                                            </a>
                                        </button>
