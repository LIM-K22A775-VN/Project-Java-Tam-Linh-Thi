...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/CssTotal/menu_admin.css"/>
</head>
<body>
            ...
            <div class="main-container">
                <div class="bin-section">
                    <button class="btn-trash">
                        <a href="bin_menu_admin.jsp" style="text-decoration: none;color:#fff;">Thùng rác</a>
                    </button>
                </div>
                ...
                <div class="container">
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            <label for="menucha">Menu cha</label>
                            <input type="number" id="menucha">
                        </div>
                        <div class="form-group">
                            <label for="vitri">Vị trí</label>
                            <input type="number" id="vitri">
                        </div>
                        <div class="form-group">
                            <button style="padding: 10px;background-color: #28a745;border-radius: 5px;border: solid 1px rgba(0,0,0,0.5);">Thêm Menu</button>
                        </div>
                    </div>
                        ...
                        <table>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>Trang chủ</td>
                                    <td><a href="intro.jsp">/trangchu</a></td>
                                    <td>custom</td>
                                    <td>mainmenu</td>
                                    <td>1</td>
                                    <td class="actions">
                                        <button class="btn-status" title="Trạng thái"><i class="fa fa-circle"></i></button>
                                        <button class="btn-view" title="Xem"><a href="detail_menu_admin.jsp" style="text-decoration: none;color: #fff;"><i class="fa fa-eye"></i></a></button>
                                        <button class="btn-edit" title="Sửa"><a href="edit_menu_admin.jsp" style="text-decoration: none;color: #fff;"><i class="fa fa-pen"></i></a></button>
