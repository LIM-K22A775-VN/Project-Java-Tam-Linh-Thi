...
<head>
    ...
    <link rel="stylesheet" href="<%= request.getContextPath() %>/static/CssTotal/edit_dish2_admin.css"/>
</head>
<body>
        ...
        <div class="main-container">
            <div class="container">
                <div class="form-section">
                    ...
                    <div class="form-group">
                        <button style="padding: 10px;background-color: #28a745;border-radius: 5px;border: solid 1px rgba(0,0,0,0.5);">
                            <a style="text-decoration: none;color: #fff;" href="dish2_admin.jsp">Lưu</a>
                        </button>
                    </div>
                </div>
            </div>
