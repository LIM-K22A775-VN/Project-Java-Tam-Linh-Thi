...
<head>
    ...
    <link rel="stylesheet" href="<%=request.getContextPath()%>/static/CssTotal/edit_dish_admin.css"/>
            ...
            <div class="container">
                <div class="form-header">
                    ...
                    <button class="btn-back">
                        <a href="show_dish2_admin.html" style="text-decoration: none;color: #fff;">
                    ...
                    <div class="form-grid">
                        <div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="slug" placeholder="Nhập slug">
                            </div>

                            <div class="form-group">
                                <label for="desc">Mô tả</label>
                                <textarea id="desc" placeholder="Nhập mô tả sản phẩm"></textarea>
                            </div>
                        ...
                        <div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" id="price" value="78000">
                            </div>

                            <div class="form-group">
                                <label for="sale">Giá khuyến mãi</label>
                                <input type="number" id="sale" value="46000">
                            </div>

                            <div class="form-group">
                                <label for="stock">Số lượng</label>
                                <input type="number" id="stock" value="40">
                            </div>
                            ...
                            <div class="form-group">
                                <label><input type="checkbox" id="newProduct"> Sản phẩm mới</label>
                            </div>
