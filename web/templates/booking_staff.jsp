                ...
                <c:forEach var="item" items="${reservations}">
                    <div class="booking-card"
                        data-status="<c:choose>
                            <c:when test='${item.booking_status == "Đã đặt"}'>reserved</c:when>
                            <c:when test='${item.booking_status == "Đã thanh toán"}'>paid</c:when>
                            <c:when test='${item.booking_status == "Đã hủy"}'>cancelled</c:when>
                        ...
                        <div class="booking-info">
                            ...
                            <p><strong>Trạng thái đơn:</strong>
                                <c:choose>
                                    <c:when test='${item.booking_status == "Đã đặt"}'>
                                        <span class="status-tag status-reserved">Đã đặt bàn</span>
                                    </c:when>
                                    <c:when test='${item.booking_status == "Đã thanh toán"}'>
                                        <span class="status-tag status-paid">Đã thanh toán</span>
                                    </c:when>
                                    <c:when test='${item.booking_status == "Đã hủy"}'>
                        ...
                        <button class="choose-btn" onclick="window.location.href='staff_order?bookingId=${item.IdTable}'">
