        ...
        <aside class="sidebar" id="sidebar">
            ...
            <ul>
                ...
                <li class="has-submenu">
                    <a href="#" class="submenu-toggle"><i class="fas fa-utensils"></i>&nbsp; Món ăn 
                        <i class="fas fa-angle-left" style="margin-left:auto"></i>
                    </a>
                    <ul class="submenu">
                ...
                <li class="has-submenu">
                    <a href="#" class="submenu-toggle"><i class="fas fa-newspaper"></i>&nbsp; Bài viết 
                        <i class="fas fa-angle-left" style="margin-left:auto"></i>
                    </a>
                    <ul class="submenu">
                ...
                <li class="has-submenu">
                    <a href="#" class="submenu-toggle"><i class="fas fa-warehouse"></i>&nbsp; Quản lý kho 
                        <i class="fas fa-angle-left" style="margin-left:auto"></i>
                    </a>
                    <ul class="submenu">
                ...
                <li class="has-submenu">
                    <a href="#" class="submenu-toggle"><i class="fas fa-palette"></i>&nbsp; Giao diện 
                        <i class="fas fa-angle-left" style="margin-left:auto"></i>
                    </a>
                    <ul class="submenu">
                ...
                <li class="has-submenu">
                    <a href="#" class="submenu-toggle"><i class="fas fa-users"></i>&nbsp; Thành Viên 
                        <i class="fas fa-angle-left" style="margin-left:auto"></i>
                    </a>
                    <ul class="submenu">
        ...
        <div class="main" id="main">
            ...
            <div class="content">
                <div class="trash-header">
                    <a href="show_theme_admin.jsp" class="btn btn-back">⬅ Quay lại danh sách</a>
                </div>
                    ...
                    <table class="trash-table">
                        ...
                        <tbody>
                            <c:forEach var="post" items="${trashList}">
                                <tr>
                                    <td>${post.id}</td>
                                    <td><img src="${pageContext.request.contextPath}/static/avatars/media/${post.image}" width="50"></td>
                                    <td style="max-width: 150px;">${post.title}</td>
                                    <td style="max-width: 150px;">${post.description}</td>
                                    <td>${post.type}</td>
                                    <td>
                                        <form action="RestorePostServlet" method="post" style="display:inline;">
                                        ...
                                        <form action="DeletePostPermanentlyServlet" method="post" style="display:inline;">
                                            <input type="hidden" name="id" value="${post.id}">
