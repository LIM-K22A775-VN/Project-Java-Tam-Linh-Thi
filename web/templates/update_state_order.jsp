...
<div class="main" id="main">
    ...
    <div class="inner-position">
        ...
        <div class="position-right">
            ...
            <a href="order_admin.jsp">Danh sách đơn hàng /</a>
    ...
    <div class="content">
        <div class="container">
            <form action="order_admin.jsp" method="get" class="form_state">
                <label for="filter">Trạng thái đơn hàng:</label>
                <br>
                <select id="filter" name="filter">
                    <option value="pending">Đang chờ xử lý</option>
                    <option value="confirmed">Đã vận chuyển</option>
