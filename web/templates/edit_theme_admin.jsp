                    ...
                    <form action="updateTheme" method="post">
                        <div class="form-section">
                            <div class="form-group">
                                ...
                                <input type="text" id="ten" name="ten" value="${theme.ten}">
                            </div>
                            <div class="form-group">
                                <label for="slug">Slug</label>
                                <input type="text" id="slug" name="slug" value="${theme.slug}">
                            </div>
                            <div class="form-group">
                                <label for="mo-ta">Mô tả</label>
                                <input type="text" id="mo-ta" name="mota" value="${theme.mota}">
                            </div>
                            <div class="form-group">
                                <label for="sap-xep">Sắp xếp</label>
                                <select id="sap-xep" name="sapxep">
                                    <option value="None" ${theme.sapxep == 'None' ? 'selected' : ''}>None</option>
                                    <!-- Các option khác có thể thêm ở đây -->
                                </select>
                            </div>
                            <div class="form-group">
                                <label for="trang-thai">Trạng thái</label>
                                <select id="trang-thai" name="trangthai">
                                    <option value="0" ${theme.trangthai == 0 ? 'selected' : ''}>Chưa xuất bản</option>
                                    <option value="1" ${theme.trangthai == 1 ? 'selected' : ''}>Đã xuất bản</option>
                                </select>
                            </div>
                            <div class="form-group">
                                <button type="submit" style="padding: 10px;background-color: #28a745;border-radius: 5px;border: solid 1px rgba(0,0,0,0.5);color:#fff;">
                                    Lưu
                                </button>
                            </div>
                        </div>
