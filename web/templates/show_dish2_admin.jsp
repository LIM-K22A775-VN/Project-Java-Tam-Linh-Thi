            ...
            <div class="container">
                <div class="filter-bar">
                    ...
                    <button class="btn-add">
                        <a href="add_dish2_admin.jsp" style="text-decoration: none;color: #fff;">
                            <i class="fa fa-plus"></i> Thêm
                        </a>
                    </button>
                    <button class="btn-trash">
                        <a href="bin_dish2_admin.jsp" style="text-decoration: none;color: #fff;">
                ...
                <div class="table">
                    <table>
                        ...
                        <tbody>
                            <!-- Dữ liệu có thể đưa vào JSP bằng JSTL hoặc scriptlet -->
                            <tr>
                                ...
                                <td class="actions">
                                    ...
                                    <button class="btn-view" title="Xem">
                                        <a href="detail_dish2_admin.jsp" style="text-decoration: none;color: #fff;">
                                            <i class="fa fa-eye"></i>
                                        </a>
                                    </button>
                                    <button class="btn-edit" title="Sửa">
                                        <a href="update_dish2_admin.jsp" style="text-decoration: none;color: #fff;">
                                            <i class="fa fa-pen"></i>
                                        </a>
                                    </button>
