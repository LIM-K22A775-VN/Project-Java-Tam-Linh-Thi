        ...
        <div class="main" id="main">
            ...
            <div class="content">
                <div class="trash-header">
                    <a href="menu_admin.jsp" class="btn btn-back">⬅ Quay lại danh sách</a>
                </div>
                <div class="table">
                    <table class="trash-table">
                        ...
                        <tbody>
                            <c:forEach var="menu" items="${trashList}">
                                <tr>
                                    <td>${menu.id}</td>
                                    <td>${menu.tenMenu}</td>
                                    <td><a href="${menu.lienKet}">${menu.lienKet}</a></td>
                                    <td>${menu.loai}</td>
                                    <td>${menu.bang}</td>
                                    <td>${menu.menuCha}</td>
                                    <td>${menu.viTri}</td>
                                    <td>
                                        <form action="restoreMenu" method="post" style="display:inline;">
                                            <input type="hidden" name="id" value="${menu.id}">
                                            <button type="submit" class="btn btn-success">
                                                <i class="fas fa-undo"></i> Khôi phục
                                            </button>
                                        </form>
                                        <form action="deleteMenuPermanently" method="post" style="display:inline;">
                                            <input type="hidden" name="id" value="${menu.id}">
