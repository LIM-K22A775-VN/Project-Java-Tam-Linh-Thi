        ...
        <ul>
            ...
            <li class="has-submenu">
                ...
                <ul class="submenu">
                    ...
                    <li><a href="storage4_admin.jsp" class="active">Đồ khô</a></li>
                </ul>
            </li>
            ...
            <div class="container">
                <div class="form-header">
                    ...
                    <button class="btn-back">
                        <a href="storage4_admin.jsp" style="text-decoration: none;color: #fff;">
                            <i class="fa fa-arrow-left"></i> Về danh sách
                        </a>
                    </button>
                </div>

                <form action="updateStorage4" method="post">
                    <div class="form-grid">
                        <!-- Cột trái -->
                        <div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" id="soluong" name="soluong" value="${product.soluong}">
                            </div>
                            <div class="form-group">
                                <label for="canhbao">Ngưỡng cảnh báo</label>
                                <input type="number" id="canhbao" name="canhbao" value="${product.canhbao}">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" id="datenh" name="datenh" value="${product.datenh}">
                            </div>
                            <div class="form-group">
                                <label for="datee">Hạn sử dụng</label>
                                <input type="date" id="datee" name="datee" value="${product.datee}">
                            </div>
                        </div>
                        ...
                        <div>
                            <div class="form-group">
                                ...
                                <select id="donvi" name="donvi">
                                    <option value="kg" ${product.donvi == 'kg' ? 'selected' : ''}>kg</option>
                                    <option value="gói" ${product.donvi == 'gói' ? 'selected' : ''}>gói</option>
                                    <option value="chai" ${product.donvi == 'chai' ? 'selected' : ''}>chai</option>
                                </select>
                            </div>

                            <div class="form-group">
                                <label for="ghichu">Ghi chú</label>
                                <textarea id="ghichu" name="ghichu" rows="5">${product.ghichu}</textarea>
                            </div>
                        </div>
                    </div>
                </form>
