            ...
            <ul>
                ...
                <li class="has-submenu">
                    ...
                    <ul class="submenu">
                        ...
                        <li><a href="library_admin.jsp" class="active">Thư viện ảnh</a></li>
        ...
        <div class="main" id="main">
            ...
            <div class="content">
                <div class="trash-header">
                    <a href="library_admin.jsp" class="btn btn-back">⬅ Quay lại danh sách</a>
                </div>
                ...
                <div class="table">
                    <table class="trash-table">
                        ...
                        <tbody>
                            <c:forEach var="img" items="${listDeletedImages}">
                                <tr>
                                    <td>${img.id}</td>
                                    <td><img src="${pageContext.request.contextPath}/static/avatars/media/${img.path}" alt="${img.tenAnh}" width="70"></td>
                                    <td>${img.tenAnh}</td>
                                    <td>${img.slug}</td>
                                    <td>${img.moTa}</td>
                                    <td>
                                        <form action="KhoiPhucHinhAnhServlet" method="post" style="display:inline;">
                                            <input type="hidden" name="id" value="${img.id}">
                                            <button type="submit" class="btn btn-success"><i class="fas fa-undo"></i> Khôi phục</button>
                                        </form>
                                        <form action="XoaVinhVienHinhAnhServlet" method="post" style="display:inline;">
                                            <input type="hidden" name="id" value="${img.id}">
