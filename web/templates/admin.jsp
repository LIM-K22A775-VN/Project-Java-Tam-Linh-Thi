    ...
    <div class="main" id="main">
        ...
        <div class="inner-position">
            ...
            <div class="position-right">
                <a href="${pageContext.request.contextPath}/intro_qc.jsp">Trang chủ /</a>
                <p>Dashboard</p>
            </div>
        </div>
            ...
            <div class="dashboard-content">
                <div class="dashboard-tab">
                    <div class="section-tab">
                        <button class="btn-tab blue">Xem sản phẩm</button>
                        <button class="btn-tab teal">Xem danh mục</button>
                        <button class="btn-tab green">Xem thương hiệu</button>
                    </div>
                ...
                <div class="appreciate-dish">
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                <td>1</td>
                                <td><img src="${pageContext.request.contextPath}/static/avatars/media/1.jpg" alt="Salad"></td>
                                <td>Salad rau mùa sốt mắc mật</td>
                                <td>4</td>
                            </tr>
                            <tr>
                                <td>2</td>
                                <td><img src="${pageContext.request.contextPath}/static/avatars/media/1.jpg" alt="Salad"></td>
                                <td>Bò cuộn kim châm</td>
                                <td>2</td>
                            </tr>
                            <tr>
                                <td>3</td>
