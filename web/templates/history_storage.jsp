...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/CssTotal/history_storage.css"/>
    ...
    <div class="main" id="main">
        ...
        <div class="content">
            <div class="container">
                ...
                <div class="buttons">
                    <button onclick="showTable('nhap')">Lịch sử phiếu nhập</button>
                    <button onclick="showTable('xuat')">Lịch sử phiếu xuất</button>
                    <button class="return">
                        <a href="import_storage_admin.jsp" style="text-decoration: none;color:#fff;">
                            Quay lại
                        </a>
                    </button>
                </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn-view" title="Xem">
                                    <a class="eye-link" href="detail_import_storage.jsp" style="text-decoration: none;color:#fff;">
                                        <i class="fa fa-eye"></i>
                                    </a>
                                </button>
                            </td>
                ...
                <!-- BẢNG XUẤT -->
                <table id="table-xuat" class="hidden">
                    <thead>
                        <tr>
                            <th>ID</th>
                            <th>Người thực hiện</th>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <button class="btn-view" title="Xem">
                                    <a class="eye-link" href="detail_export_storage.jsp" style="text-decoration: none;color:#fff;">
                                        <i class="fa fa-eye"></i>
                                    </a>
                                </button>
                            </td>
...
function showTable(type) {
  document.getElementById('table-nhap').classList.add('hidden');
  document.getElementById('table-xuat').classList.add('hidden');

  if (type === 'nhap') {
    document.getElementById('table-nhap').classList.remove('hidden');
  } else {
    document.getElementById('table-xuat').classList.remove('hidden');
  }
}

// Hiển thị mặc định bảng nhập
showTable('nhap');
</script>
</html>
