...
<head>
    ...
    <link rel="stylesheet" href="<%=request.getContextPath()%>/static/CssTotal/update_state.css"/>
</head>
<body>
    ...
    <div class="main" id="main">
        ...
        <div class="inner-position">
            <h2>Cập nhật tư vấn</h2>
            <div class="position-right">
                <a href="admin.html">Trang chủ /</a>
                <a href="consultant_admin.html">Tư vấn /</a>
                <p>Cập nhật</p>
            </div>
        </div>
        ...
        <div class="content">
            <div class="container">
                <form action="consultant_admin.html" class="form_state" method="get">
                    ...
                    <br><!-- comment -->
                    <button class="btn-select" value="find">Cập nhật</button>
                </form>
            </div>
        </div>
    </div>
