    ...
    <div class="main" id="main">
        ...
        <div class="content">
            <div class="trash-header">
                <a href="customer_admin.jsp" class="btn btn-back">⬅ Quay lại danh sách</a>
            </div>
                ...
                <table class="trash-table">
                    <thead>
                        <tr>
                            ...
                            <th>Điểm tích lũy</th>
                            <th>Đơn hàng</th>
                            <th style="min-width: 280px;">Chức năng</th>
                        </tr>
                    </thead>
                    <tbody>
                        <c:forEach var="kh" items="${listKhachHangXoa}">
                            <tr>
                                <td>${kh.id}</td>
                                <td><img src="${pageContext.request.contextPath}/static/avatars/media/${kh.hinh}" alt="Ảnh KH"></td>
                                <td>${kh.hoten}</td>
                                ...
                                <td>${kh.sodonhang}</td>
                                <td>
                                    <form action="KhoiPhucKhachHang" method="post" style="display:inline;">
                                        <input type="hidden" name="id" value="${kh.id}">
                                        <button class="btn btn-success"><i class="fas fa-undo"></i> Khôi phục</button>
                                    </form>
                                    <form action="XoaVinhVienKhachHang" method="post" style="display:inline;">
                                        <input type="hidden" name="id" value="${kh.id}">
