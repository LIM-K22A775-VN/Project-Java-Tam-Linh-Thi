                ...
                <div class="main-container">
                    <div class="bin-section">
                        <button class="btn-trash">
                            <a href="bin_storage2_admin.jsp" style="text-decoration: none;color: #fff;">
                                Thùng rác
                            </a>
                        </button>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="actions">
                                            ...
                                            <button class="btn-view" title="Xem">
                                                <a href="detail_storage2_admin.jsp" style="text-decoration: none;color: #fff;">
                                                    <i class="fa fa-eye"></i>
                                                </a>
                                            </button>
                                            <button class="btn-edit" title="Sửa">
                                                <a href="edit_storage2_admin.jsp" style="text-decoration: none;color: #fff;">
                                                    <i class="fa fa-pen"></i>
                                                </a>
                                            </button>
