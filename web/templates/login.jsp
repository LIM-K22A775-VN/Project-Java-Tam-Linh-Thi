...
<head>
    ...
    <style>
        ...
        /* QR Login: Xuân */
        .btn.qr-login {
            background: linear-gradient(135deg, #7fbf3f, #c9e265);
            transition: background 0.3s ease, transform 0.2s ease;
        }

        .btn.qr-login:hover {
            background: linear-gradient(135deg, #6ea82e, #b5cc52);
            transform: translateY(-2px);
        }

        /* Face ID Login: Thu */
        .btn.faceid-login {
            background: linear-gradient(135deg, #d98324, #f2b35a);
            transition: background 0.3s ease, transform 0.2s ease;
        }

        .btn.faceid-login:hover {
            background: linear-gradient(135deg, #c4721b, #e1a048);
            transform: translateY(-2px);
        }
