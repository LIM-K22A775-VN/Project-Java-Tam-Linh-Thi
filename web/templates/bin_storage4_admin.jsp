...
<html lang="vi">
    <head>
        ...
        <link rel="stylesheet" href="<%= request.getContextPath() %>/static/CssTotal/bin_dish_admin.css"/>
    </head>
    <body>
            ...
            <ul>
                ...
                <li class="has-submenu">
                    <a href="#" class="submenu-toggle"><i class="fas fa-utensils"></i>&nbsp; Món ăn 
                        <i class="fas fa-angle-left" style="margin-left:auto"></i></a>
                    <ul class="submenu">
        ...
        <div class="main" id="main">
            ...
            <div class="content">
                <div class="trash-header">
                    <a href="storage4_admin.jsp" class="btn btn-back">⬅ Quay lại danh sách</a>
                </div>
