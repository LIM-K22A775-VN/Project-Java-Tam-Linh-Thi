...
<html lang="vi">
    <head>
        ...
        <link rel="stylesheet" href="<c:url value='/static/CssTotal/bin_dish_admin.css'/>"/>
    </head>
    <body>
        ...
        <div class="main" id="main">
            ...
            <div class="content">
                <div class="trash-header">
                    <a href="article_admin.jsp" class="btn btn-back">⬅ Quay lại danh sách</a>
                </div>
                <div class="table">
                    <table class="trash-table">
                        ...
                        <tbody>
                            <!-- Mỗi dòng là 1 bài viết đã xóa -->
                            <tr>
                                <td>1</td>
                                <td><img src="<c:url value='/static/avatars/media/1.jpg'/>" width="50"></td>
                                <td style="max-width: 150px;">Cách làm gà ủ muối hoa tiêu thơm ngon đúng vị</td>
                                <td style="max-width: 150px;">Gà ủ muối có nhiều cách làm khác nhau, tùy vào tay mỗi đầu bếp...</td>
