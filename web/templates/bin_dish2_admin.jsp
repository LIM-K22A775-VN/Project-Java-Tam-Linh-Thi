        ...
        <div class="main" id="main">
            ...
            <div class="content">
                <div class="trash-header">
                    <a href="show_dish2_admin.jsp" class="btn btn-back">⬅ Quay lại danh sách</a>
                </div>
                ...
                <div class="table">
                    <table class="trash-table">
                        ...
                        <tbody>
                            <%-- Ví dụ dữ liệu tĩnh (sau này thay bằng dữ liệu từ DB) --%>
                            <tr>
                                <td>1</td>
                                <td><img src="${pageContext.request.contextPath}/static/avatars/media/1.jpg" width="50"></td>
                                <td>Salad rau mùa sốt cam</td>
                                <td>Món âu</td>
                                <td>82.000 VND</td>
                                <td>62.000 VND</td>
                                <td>
