...
<div class="inner-position">
    ...
    <span style="color: black;margin-left: 1px;">Thanh toán</span>
</div>

<div class="container" style="border-top: solid 1px rgba(0,0,0,0.1);padding: 50px;margin-top: 20px; box-shadow: 0 0 5px rgba(0,0,0,0.1);">
    <div>
        <h2 style="text-align: center;padding: 10px">Thanh toán thành công</h2>
        <p style="text-align: center;padding: 10px;">Cảm ơn bạn đã đặt hàng. Chúng tôi sẽ xử lý đơn hàng của bạn sớm nhất.</p>
        <div style="border-radius: 5px;border: solid 1px rgba(0,0,0,0.5); background-color: #f60; height: 50px; width: 170px; margin: 10px auto; display: flex; justify-content: center; align-items: center;">
            <a href="intro.jsp" style="text-decoration: none; color: #fff;">Quay lại trang chủ</a>
        </div>
    </div>
</div>
