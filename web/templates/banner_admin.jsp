...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/CssTotal/banner_admin.css"/>
</head>
<body>
        ...
        <div class="navbar">
            ...
            <div class="navbar-right">
                ...
                <div class="user-info">
                    ...
                    <span><%= session.getAttribute("admin_name") != null ? session.getAttribute("admin_name") : "Admin" %></span>
            ...
            <div class="main-container">
                <div class="bin-section">
                    <button class="btn-trash">
                        <a href="bin_banner_admin.jsp" style="text-decoration: none;color:#fff;">
                            Thùng rác
                        </a>
                    </button>
                </div>
                ...
                <div class="container">
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="area" id="mo-ta" name="mo-ta" rows="4" cols="10"></textarea>
                        </div>
                        <div class="form-group">
                            <label for="vi-tri">Vị trí</label>
                            <select id="vi-tri">
                                <option>None</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            <button style="padding: 10px;background-color: #28a745;border-radius: 5px;border: solid 1px rgba(0,0,0,0.5);">Thêm banner</button>
                        </div>
                    </div>
                                ...
                                <tr>
                                    ...
                                    <td class="actions">
                                        ...
                                        <button class="btn-view" title="Xem">
                                            <a href="detail_banner_admin.jsp" style="text-decoration: none;color: #fff;"><i class="fa fa-eye"></i></a>
                                        </button>
                                        <button class="btn-edit" title="Sửa">
                                            <a href="edit_banner_admin.jsp" style="text-decoration: none;color: #fff;"><i class="fa fa-pen"></i></a>
                                        </button>
                                        <button class="btn-delete" title="Xóa"><i class="fa fa-trash"></i></button>
                                    </td>
                                    <td>1</td>
                                </tr>
                                <!-- Có thể lặp cho các banner khác bằng JSTL -->
                            </tbody>
                        </table>
