            ...
            <div class="content">
                <div class="container">
                    <div class="detail-header">
                        <div class="btn-group">
                            <form action="deleteStorage" method="post" style="display:inline;">
                            ...
                            <button class="btn btn-back">
                                <a href="storage2_admin.jsp" style="text-decoration: none; color:#fff;">
                    ...
                    <table class="detail-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>${storage.tenNguyenLieu}</td>
                            </tr>
                            <tr>
                                <td>Số lượng</td>
                                <td>${storage.soLuong}</td>
                            </tr>
                            <tr>
                                <td>Loại</td>
                                <td>${storage.loai}</td>
                            ...
                            <tr>
                                <td>Giá nhập trung bình</td>
                                <td>${storage.giaNhapTrungBinh}</td>
                            </tr>
                            <tr>
                                <td>Ngưỡng cảnh báo</td>
                                <td>${storage.nguongCanhBao}</td>
                            </tr>
                            <tr>
                                <td>Đơn vị</td>
                                <td>${storage.donVi}</td>
                            ...
                            <tr>
                                <td>Ghi chú</td>
                                <td>${storage.ghiChu}</td>
                            </tr>
                            <tr>
                                <td>Ngày nhập</td>
                                <td>${storage.ngayNhap}</td>
                            </tr>
                            <tr>
                                <td>Hạn sử dụng</td>
                                <td>${storage.hanSuDung}</td>
                            </tr>
                            <tr>
                                <td>Tình trạng</td>
                                <td>${storage.tinhTrang}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
