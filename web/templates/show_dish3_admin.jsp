...
<head>
    ...
    <link rel="stylesheet" href="../static/CssTotal/show_dish2_admin.css"/>
</head>
<body>
            ...
            <div class="container">
                <div class="filter-bar">
                    ...
                    <button class="btn-add">
                        <a href="add_dish3_admin.jsp" style="text-decoration: none;color: #fff;">
                            <i class="fa fa-plus"></i> Thêm
                        </a>
                    </button>
                    <button class="btn-trash">
                        <a href="bin2_dish3_admin.jsp" style="text-decoration: none;color: #fff;">
                ...
                <div class="table">
                    <table>
                        ...
                        <tbody>
                            <!-- Dữ liệu bảng tĩnh, có thể chuyển sang JSTL nếu muốn động -->
                            <tr>
                                <td><input type="checkbox" class="review-checkbox"></td>
                                <td><img src="../static/avatars/media/1.jpg" alt="Món ăn"></td>
                                <td>Salad rau mùa sốt cam</td>
                                <td>Khai vị</td>
                                <td>82.000 VND</td>
                                <td>68.000 VND</td>
                                <td>75</td>
                                <td><span class="label-new">Sản phẩm mới</span></td>
                                <td class="actions">
                                    <button class="btn-status" title="Trạng thái"><i class="fa fa-circle"></i></button>
                                    <button class="btn-view" title="Xem">
                                        <a href="detail_dish3_admin.jsp" style="text-decoration: none;color: #fff;">
                                            <i class="fa fa-eye"></i>
                                        </a>
                                    </button>
                                    <button class="btn-edit" title="Sửa">
                                        <a href="update_dish3_admin.jsp" style="text-decoration: none;color: #fff;">
                                            <i class="fa fa-pen"></i>
                                        </a>
                                    </button>
