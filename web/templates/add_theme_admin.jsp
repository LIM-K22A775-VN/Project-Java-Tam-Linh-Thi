        ...
        <div class="container">
            <div class="form-header">
                ...
                <button class="btn-back">
                    <a href="show_theme_admin.jsp" style="text-decoration: none;color: #fff;">
                ...
                <div class="form-grid">
                    <div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="mo-ta" name="description" placeholder="Nhập mô tả bài viết"></textarea>
                        </div>

                        <div class="form-group">
                            <label for="loai">Loại</label>
                            <input type="text" id="loai" name="category" placeholder="Nhập loại bài viết">
                        </div>
                    ...
                    <div>
                        ...
                        <div class="form-group">
                            <label><input type="checkbox" id="newProduct" name="isNew"> Sản phẩm mới</label>
                        </div>
