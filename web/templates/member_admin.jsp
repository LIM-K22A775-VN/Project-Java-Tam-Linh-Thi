            ...
            <div class="container">
                <div class="filter-bar">
                    ...
                    <button class="btn-trash">
                        <a href="bin_member_admin.jsp" style="text-decoration: none;color: #fff;">
                ...
                <div class="table">
                    <table>
                        ...
                        <tbody>
                            <!-- Dữ liệu thành viên có thể lặp từ servlet -->
                            <tr>
                                <td><input type="checkbox"></td>
                                <td><img src="${pageContext.request.contextPath}/static/avatars/media/1.jpg" alt="Món ăn"></td>
                                <td>Nguyễn Văn A</td>
                                <td>NVA123456</td>
                                <td>0987265336</td>
                                <td>a@gmail.com</td>
                                ...
                                <td class="actions">
                                    ...
                                    <button class="btn-view" title="Xem">
                                        <a href="detail_member_admin.jsp" style="text-decoration: none;color: #fff;">
                                            <i class="fa fa-eye"></i>
                                        </a>
                                    </button>
                                    <button class="btn-add-admin" title="Thêm Admin"><i class="fa fa-user"></i> Thêm Admin</button>
