...
<div class="navbar">
    <div class="navbar-title">
        ...
        <a href="dashboard_staff.jsp">Trang chủ</a>
    ...
    <div class="navbar-right">
        ...
        <div class="auth-buttons" id="authButtons">
            <a href="loginstaff.jsp" class="loginicon">Đăng nhập</a>
            <a href="signup_staff.jsp" class="loginicon">Đăng ký</a>
        ...
        <div class="user-info" id="userInfo" style="display: none;">
            ...
            <span id="usernameDisplay">Phan Linh</span>
            <div class="user-dropdown" id="userDropdown">
                <a href="profile_staff.jsp"><i class="fas fa-user-circle"></i> Hồ sơ</a>
