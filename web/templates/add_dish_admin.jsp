...
<head>
    ...
    <link rel="stylesheet" href="../static/CssTotal/edit_dish_admin.css"/>
        ...
        <div class="content">
            <div class="container">
                <div class="form-header">
                    <button class="btn-save"><i style="vertical-align: middle; margin-right: 6px;" class="fa-solid fa-square-plus"></i> Thêm</button>
                    <button class="btn-back">
                        <a href="dish_admin.jsp" style="text-decoration: none;color: #fff;">
                            <i style="vertical-align: middle; margin-right: 6px;" class="fa fa-arrow-left"></i> Về danh sách
                        </a>
                    </button>
                </div>

                <form action="AddDishServlet" method="post" enctype="multipart/form-data">
                    <div class="form-grid">
                        <div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="desc" id="desc" placeholder="Nhập mô tả sản phẩm"></textarea>
                            </div>
                        ...
                        <div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="price" id="price" value="78000">
                            </div>

                            <div class="form-group">
                                <label for="sale">Giá khuyến mãi</label>
                                <input type="number" name="sale" id="sale" value="46000">
                            </div>

                            <div class="form-group">
                                <label for="stock">Số lượng</label>
                                <input type="number" name="stock" id="stock" value="40">
                            </div>
