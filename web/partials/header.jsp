...
<header class="header">
    ...
    <div class="navbar">
        ...
        <div class="navbar_item"><a href="<c:url value='/templates/Menu.jsp' />">Thực đơn</a></div>
        <div class="navbar_item"><a href="<c:url value='/templates/article.jsp' />">Bài viết</a></div>
                ...
                <c:choose>
                    <c:when test="${not empty sessionScope.user}">
                        <div style="display: flex; align-items: center; gap: 8px;">
                            <img src="<c:url value='/static/avatars/${sessionScope.user.avatar}' />" alt="Avatar"
